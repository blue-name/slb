...
|:--|:-|
|**TCP监听**|
|[ZH-CN\_TP\_4205.md\#](intl.zh-CN/API参考/TCP监听/CreateLoadBalancerTCPListener.md#)|创建TCP监听。|
...
|**UDP监听**|
|[ZH-CN\_TP\_4206.md\#](intl.zh-CN/API参考/UDP监听/CreateLoadBalancerUDPListener.md#)|创建UDP监听。|
...
|**HTTP监听**|
|[ZH-CN\_TP\_4203.md\#](intl.zh-CN/API参考/HTTP监听/CreateLoadBalancerHTTPListener.md#)|创建HTTP监听。|
...
|**HTTPS监听**|
|[ZH-CN\_TP\_4204.md\#](intl.zh-CN/API参考/HTTPS监听/CreateLoadBalancerHTTPSListener.md#)|创建HTTPS监听。|
...
|[ZH-CN\_TP\_4209.md\#](intl.zh-CN/API参考/监听/StopLoadBalancerListener.md#)|停止监听。|
|**访问控制**|
|[SetAccessControlListAttribute](intl.zh-CN/API参考/访问控制/SetAccessControlListAttribute.md#)|为指定监听开启或关闭访问控制功能。|
|[DescribeAccessControlListAttribute](intl.zh-CN/API参考/访问控制/DescribeAccessControlListAttribute.md#)|查询监听的访问控制配置。|
|[AddAccessControlListEntry](intl.zh-CN/API参考/访问控制/AddAccessControlListEntry.md#)|添加监听访问控制白名单。|
|[RemoveAccessControlListEntry](intl.zh-CN/API参考/访问控制/RemoveAccessControlListEntry.md#)|删除监听白名单中的IP地址。|
|**转发策略**|
...
|:--|:-|
|**默认服务器组**|
|[ZH-CN\_TP\_4223.md\#](intl.zh-CN/API参考/后端服务器/AddBackendServers.md#)|添加默认服务器。|
...
|**虚拟服务器组**|
|[ZH-CN\_TP\_4233.md\#](intl.zh-CN/API参考/后端服务器组/CreateVServerGroup.md#)|创建虚拟服务器组，并添加后端服务器。|
...
|API|描述|
|---|--|
|[ZH-CN\_TP\_4194.md\#](intl.zh-CN/API参考/服务器证书/UploadServerCertificate.md#)|上传服务器证书。|
|[DeleteServerCertificate](intl.zh-CN/API参考/服务器证书/DeleteServerCertificate.md#)|删除服务器证书。|
|[ZH-CN\_TP\_4196.md\#](intl.zh-CN/API参考/服务器证书/DescribeServerCertificates.md#)|查询已上传的服务器证书。|
